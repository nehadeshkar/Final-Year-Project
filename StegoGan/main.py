...
class Window(Frame):
    ...
    def init_window(self):
        ...
        # Create a folder that can be configured for GUI
        ...
        # Show the method of loading the model
