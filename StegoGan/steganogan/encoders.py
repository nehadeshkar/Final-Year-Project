...
class BasicEncoder(nn.Module):
    ...
    def _build_models(self):
        ...
        self.layers = nn.Sequential(
            ...
            nn.Tanh(),
            "Using nn.Tanh() as the final activation function can be beneficial for tasks 
            "such as image generation or denoising, where the goal is to generate or reconstruct 
            "images with values within a specific range."
        )
...
class ResidualEncoder(BasicEncoder):
    ...
    def _build_models(self):
        ...
        return self.features, self.layers "neural layer" "image features/data forwards it to model"
